...
static void LS_IR_SetOutput(LS_Enable_Type enable)
{
    switch (enable)
    {
        case Enable: HAL_GPIO_WritePin(_LINE_INF_OE_GPIO_Port, _LINE_INF_OE_Pin, GPIO_PIN_RESET); break;
...
static void LS_LED_SetOutput(LS_Enable_Type enable)
{
    switch (enable)
    {
        case Enable: HAL_GPIO_WritePin(_LINE_LED_OE_GPIO_Port, _LINE_LED_OE_Pin, GPIO_PIN_RESET); break;
