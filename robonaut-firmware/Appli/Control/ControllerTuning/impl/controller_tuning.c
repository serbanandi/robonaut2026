...
//             else if (ui_state.enterButtonWasPressed) {state = APPLY_PARAM;}
//             else if (currentEncoderPos != lastEncoderPos) { _tuning_AdjustParameter(param, currentEncoderPos -
//             lastEncoderPos);} else if (ui_state.backButtonWasPressed) {state = SELECT_PARAM;} break;
