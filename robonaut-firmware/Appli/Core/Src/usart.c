...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PeriphClkInitStruct.Uart8ClockSelection = RCC_UART8CLKSOURCE_IC9;
    ...
    PE1     ------> UART8_TX
    */
    GPIO_InitStruct.Pin = CMD_RX_Pin|GPIO_PIN_1;
    ...
    /* UART8 DMA Init */
    /* GPDMA1_REQUEST_UART8_RX Init */
    handle_GPDMA1_Channel4.Instance = GPDMA1_Channel4;
    handle_GPDMA1_Channel4.Init.Request = GPDMA1_REQUEST_UART8_RX;
  ...
  */
    ...
    PG3     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = GEN_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(GEN_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GEN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(GEN_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, CMD_RX_Pin|GPIO_PIN_1);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PG3     ------> USART2_TX
    */
    HAL_GPIO_DeInit(GEN_RX_GPIO_Port, GEN_RX_Pin);

    HAL_GPIO_DeInit(GEN_TX_GPIO_Port, GEN_TX_Pin);
