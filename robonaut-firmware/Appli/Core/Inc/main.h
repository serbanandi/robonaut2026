...
#define MOT_PWM2_Pin GPIO_PIN_8
...
#define GEN_TIM_Pin GPIO_PIN_11
#define GEN_TIM_GPIO_Port GPIOE
...
#define MOT_PWM1_Pin GPIO_PIN_1
...
#define LED_DATA_Pin GPIO_PIN_2
#define LED_DATA_GPIO_Port GPIOG
